...
package mix1
  ...
  model mix
    ...
    Simulator.Unit_Operations.Mixer mixer1(NOC = NOC, NI = 6, comp = comp, outPress = "Inlet_Average") annotation(
      Placement(visible = true, transformation(origin = {-6,0}, extent = {{-26, -26}, {26, 26}}, rotation = 0)));
