...
package cooler1
  ...
  model cool
    ...
    Simulator.Unit_Operations.Cooler cooler1(pressDrop = 0, eff = 1, NOC = 3, comp = {meth, eth, wat}) annotation(
      Placement(visible = true, transformation(origin = {-6, 18}, extent = {{-14, -14}, {14, 14}}, rotation = 0)));
