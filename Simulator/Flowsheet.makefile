...
CPPFLAGS= -I"C:/OpenModelica1.12.0-64bit//include/omc/c" -I. -DOPENMODELICA_XML_FROM_FILE_AT_RUNTIME -DOMC_MODEL_PREFIX=Flowsheet -DOMC_NUM_MIXED_SYSTEMS=0 -DOMC_NUM_LINEAR_SYSTEMS=7 -DOMC_NUM_NONLINEAR_SYSTEMS=10 -DOMC_NDELAY_EXPRESSIONS=0 -DOMC_NVAR_STRING=0
...
omc_main_target: $(MAINOBJ) Flowsheet_functions.h Flowsheet_literals.h $(OFILES)
	$(CC) -I. -o Flowsheet$(EXEEXT) $(MAINOBJ) $(OFILES) $(CPPFLAGS) -L"C:/Users/thant/OneDrive/Desktop/building/Chemical-Simulator-GUI/Simulator"   $(CFLAGS) $(CPPFLAGS) $(LDFLAGS)
clean:
